...
// Datos + scoring puros, reutilizables por cualquier componente (dashboard y portal).
...
// Especialidades para las que tiene sentido mostrar las escalas de salud mental.
// (psiquiatría comparte el valor 'psicologia' en el selector de especialidad).
export const SCALE_SPECIALTIES = ['psicologia', 'clinica', 'general', 'nutricion']

export function showsScales(specialty?: string | null): boolean {
  return SCALE_SPECIALTIES.includes(specialty ?? '')
}
