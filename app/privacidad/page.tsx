    ...
    <div className="min-h-screen bg-[#F5F5F7] p-5 md:p-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#0A0A0A]">Política de Privacidad</h1>
        ...
        <div className="flex flex-col gap-6">
          ...
          {[
              ...
              extra: (
                <div className="flex flex-col gap-3">
                  <div className="bg-[#F5F5F7] rounded-2xl p-4">
                    <p className="text-xs text-[#6E6E73] font-medium uppercase tracking-widest mb-1.5">Del profesional de salud</p>
                    <p className="text-sm text-[#0A0A0A] leading-relaxed">Nombre, correo electrónico, contraseña e información de perfil profesional.</p>
                  </div>
                  <div className="bg-[#F5F5F7] rounded-2xl p-4">
                    <p className="text-xs text-[#6E6E73] font-medium uppercase tracking-widest mb-1.5">De los pacientes (ingresados por el profesional)</p>
                    <p className="text-sm text-[#0A0A0A] leading-relaxed">Nombre completo, teléfono, fecha de nacimiento, diagnósticos, notas clínicas, transcripciones de sesiones, resúmenes generados por IA y agenda de turnos.</p>
                  </div>
                </div>
              )
            },
            ...
            },
            {
              ...
              extra: (
                <div className="flex flex-col gap-3">
                  ...
                  <div className="bg-[#F5F5F7] rounded-2xl p-4">
                    <p className="text-xs text-[#6E6E73] font-medium uppercase tracking-widest mb-1.5">Argentina</p>
                    <p className="text-sm text-[#0A0A0A] leading-relaxed">Ley 25.326 de Protección de Datos Personales. Organismo de control: AAIP.</p>
                  </div>
                  <div className="bg-[#F5F5F7] rounded-2xl p-4">
                    <p className="text-xs text-[#6E6E73] font-medium uppercase tracking-widest mb-1.5">Resto de Latinoamérica</p>
                    <p className="text-sm text-[#0A0A0A] leading-relaxed">Se aplican los principios generales de protección de datos conforme a la legislación local vigente en cada país.</p>
                  </div>
                </div>
              )
            },
            ...
            <div key={title} className="bg-white rounded-3xl border border-[#EDEDED] p-6">
              ...
              {content && <p className="text-sm text-[#6E6E73] leading-relaxed">{content}</p>}
              {extra}
            </div>
          ))}
