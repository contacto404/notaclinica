...
<style>
  ...
  .section-label { font-size: 11px; color: #6E6E73; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 6px; font-weight: bold; }
  .section-content { font-size: 14px; line-height: 1.6; background: #F5F5F7; padding: 12px; border-radius: 8px; }
  .med-row { display: flex; flex-direction: column; padding: 10px 12px; background: #F5F5F7; border-radius: 8px; margin-bottom: 8px; }
  .med-name { font-weight: bold; font-size: 14px; }
  .med-detail { font-size: 13px; color: #666; margin-top: 2px; }
  .next-apt { background: #F0F0F0; padding: 14px; border-radius: 8px; font-size: 15px; font-weight: bold; color: #0A0A0A; text-align: center; }
