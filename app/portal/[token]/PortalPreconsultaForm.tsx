...
export default function PortalPreconsultaForm({ token }: { token: string }) {
  ...
  if (done) {
    return (
      <div className="bg-white rounded-2xl border border-[#EDEDED] p-6 text-center mb-4">
        ...
        <p className="text-base font-bold text-[#0A0A0A] mb-1">¡Listo!</p>
        <p className="text-sm text-[#6E6E73]">Tu profesional va a tener esta información antes de la consulta.</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#EDEDED] p-5 mb-4">
      <p className="text-[11px] text-[#6E6E73] uppercase tracking-widest mb-1">Antes de tu consulta</p>
      <p className="text-sm text-[#6E6E73] mb-5">Completá esto para aprovechar mejor la sesión. Solo lo ve tu profesional.</p>

      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-[#0A0A0A]">¿Cuál es el motivo de la consulta? *</label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-[#0A0A0A]">Antecedentes relevantes</label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-[#0A0A0A]">Medicación actual</label>
