  ...
  return (
    <>
      <button onClick={() => setOpen(true)}
        className="text-xs text-[#A08070] hover:text-red-500 transition-colors underline underline-offset-2">
      ...
      {open && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-6 w-full max-w-sm border border-[#F0E8E0] shadow-xl">
            <h3 className="text-base font-bold text-[#2D1F14] mb-2">¿Dar de baja a {patientName}?</h3>
            <p className="text-sm text-[#A08070] mb-6">Esta acción eliminará al paciente y todo su historial de sesiones. No se puede deshacer.</p>
