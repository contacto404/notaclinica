  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <header
        ...
        style={{ paddingTop: 'max(calc(var(--safe-top) - 12px), 6px)' }}
      >
        <div className="px-4 flex items-center justify-center h-12">
          <img src="/logo-v2.png" alt="NotaClínica" className="h-11 w-auto dark:hidden" />
          <img src="/logo-white-v2.png" alt="NotaClínica" className="h-11 w-auto hidden dark:block" />
        </div>
      </header>
      ...
      <aside className="hidden md:flex flex-col fixed top-0 left-0 h-full w-56 bg-[#F5F5F7] border-r border-[#EDEDED] py-6 px-3 z-40">
        <div className="mb-8 px-3">
          <img src="/logo-v2.png" alt="NotaClínica" className="h-10 w-auto dark:hidden" />
          <img src="/logo-white-v2.png" alt="NotaClínica" className="h-10 w-auto hidden dark:block" />
        </div>
