    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      >
        <div className="px-4 flex items-center justify-center h-14">
          <img src="/logo-v2.png" alt="NotaClínica" className="h-12 w-auto dark:hidden" />
          <img src="/logo-white-v2.png" alt="NotaClínica" className="h-12 w-auto hidden dark:block" />
        </div>
      </header>
